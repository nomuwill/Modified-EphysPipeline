...
def plot_raster_with_fr(train:list, title:list, avg=False, axs=None):
    bins, fr_avg = utils.get_population_fr(trains=train, average=avg)
    if axs is None:
    ...
    axs1.set_ylim(0, 4)   # make this tunable 
...
def plot_activity_map(qm_path, title, axs=None):
    """
